...
-- ldbanno -n VHDL -o oscilloscope_impl1_mapvho.vho -w -neg -gui oscilloscope_impl1_map.ncd 
-- Netlist created on Sat Feb 19 23:09:39 2022
-- Netlist written on Sat Feb 19 23:09:42 2022
  ...
  begin
    ...
    SLICE_12I: SLICE_12
      port map (A1=>cnt_0, DI1=>n125, LSR=>cnt_23_N_51, CLK=>clk_c, F1=>n125, 
                Q1=>cnt_0, FCO=>n198);
    SLICE_13I: SLICE_13
      port map (D1=>n20_adj_1, C1=>cnt_10, B1=>cnt_12, A1=>cnt_11, C0=>cnt_8, 
                B0=>cnt_9, A0=>cnt_7, F0=>n20_adj_1, F1=>n4);
    SLICE_14I: SLICE_14
      port map (D1=>n4_adj_3, C1=>cnt_19, B1=>n223, A1=>cnt_20, D0=>n4_adj_2, 
                C0=>cnt_22, B0=>cnt_23, A0=>cnt_21, F0=>cnt_23_N_51, 
                F1=>n4_adj_2);
    SLICE_15I: SLICE_15
      port map (D1=>cnt_18, C1=>n225, B1=>cnt_19, A1=>cnt_20, D0=>cnt_21, 
                C0=>cnt_22, B0=>cnt_23, A0=>n210, F0=>led2_c, F1=>n210);
    SLICE_16I: SLICE_16
      port map (D1=>n4, C1=>cnt_15, B1=>n226, A1=>n223, B0=>cnt_16, A0=>cnt_17, 
                F0=>n223, F1=>n225);
    SLICE_17I: SLICE_17
      port map (B1=>cnt_13, A1=>cnt_14, D0=>cnt_15, C0=>n215, B0=>cnt_18, 
                A0=>n226, F0=>n4_adj_3, F1=>n226);
    SLICE_18I: SLICE_18
      port map (D1=>n14, C1=>cnt_8, B1=>cnt_9, A1=>n13, D0=>cnt_10, C0=>n20, 
                B0=>cnt_11, A0=>cnt_12, F0=>n215, F1=>n20);
    SLICE_19I: SLICE_19
      port map (D1=>cnt_7, C1=>cnt_4, B1=>cnt_6, A1=>cnt_0, D0=>cnt_1, 
                C0=>cnt_3, B0=>cnt_5, A0=>cnt_2, F0=>n14, F1=>n13);
    SLICE_20I: SLICE_20
      port map (D0=>cnt_21, C0=>cnt_22, B0=>cnt_23, A0=>n210, F0=>n234);
    led2I: led2B
