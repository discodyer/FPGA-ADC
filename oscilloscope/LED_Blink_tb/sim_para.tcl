...
set ::bali::simulation::Para(PROJECT) {LED_Blink_tb}
set ::bali::simulation::Para(PROJECTPATH) {/home/cody/Project/FPGA-ADC/oscilloscope}
set ::bali::simulation::Para(FILELIST) {"/home/cody/Project/FPGA-ADC/oscilloscope/LED_Blink_tb/LED_Blink.v" "/home/cody/Project/FPGA-ADC/oscilloscope/LED_Blink_tb/LED_Blink_tb.v" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {LED_shining_tb}
